...
var sampleLifts: [lift] = [
    ...
    lift(type: "bench", amount: 270, date: Date(timeIntervalSinceNow: -120000), isPersonalRecord: true),
    lift(type: "squat", amount: 185, date: Date(timeIntervalSinceNow: -3400), isPersonalRecord: false),
    lift(type: "squat", amount: 315, date: Date(timeIntervalSinceNow: -610000), isPersonalRecord: false),
    ...
    lift(type: "deadlift", amount: 805, date: Date(timeIntervalSinceNow: -850000), isPersonalRecord: true),
